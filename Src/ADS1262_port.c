...
HAL_StatusTypeDef ads_port_spi_transmit_receive(SPI_HandleTypeDef *hspi,
                                                const uint8_t *pTxData,
                                                uint8_t *pRxData, uint16_t Size,
                                                uint32_t Timeout) {
  return HAL_SPI_TransmitReceive(hspi, (uint8_t *)pTxData, pRxData, Size,
                                 Timeout);
}

HAL_StatusTypeDef ads_port_spi_transmit(SPI_HandleTypeDef *hspi,
